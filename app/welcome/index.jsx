...
export default function Index() {
  ...
  const handleroute =()=>{
    router.push("/choices"); // ✅ Navigate to Welcome page
  ...
  return (
    <View className="flex-1 relative justify-end bg-[#E53842]">
      ...
      <View className="w-full h-[340px]  rounded-t-[40px] p-5 pb-20 bg-white relative z-10">
  {/* Updated Heading */}
  <Text className="text-3xl mt-4 text-center font-bold">
    Find Your Perfect Fitness Trainer
  </Text>

  {/* Updated Subheading */}
  <Text className="text-xl my-2 text-center text-slate-600">
    Discover certified trainers near you, book sessions, and achieve your fitness goals with ease.
  </Text>
  

  {/* Button */}
  <TouchableOpacity
    className="w-full mt-auto py-2 rounded-full px-10 bg-[#E53842]"
    onPress={() => handleroute()}
  >
